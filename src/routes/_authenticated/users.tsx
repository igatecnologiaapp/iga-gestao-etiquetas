...
function UsersPage() {
  ...
  const manageable = useMemo(
    () => (companies ?? []).filter((c) => c.role === "administrador"),
    [companies],
  );
  const [companyId, setCompanyId] = useState<string>("");

  // selecionar a primeira empresa admin se nenhuma
      ...
      {manageable.length === 0 ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Apenas administradores podem gerenciar usuários. Solicite ao Administrador da sua empresa.
            </CardDescription>
          </CardHeader>
        </Card>
      ) : (
        <>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Usuários com perfil ativo nesta empresa.</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
